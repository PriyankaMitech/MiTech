                                ...
                                <div class="note">Note: All fields marked with * are compulsory.</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="checkbox" id="access_<?= $i ?>" name="access_level[]"
                                            value="<?= $data->url_location; ?>" class="access-level-checkbox"
...
$(document).ready(function() {
    const defaultAccessLevels = {
        Admin: [ 'saveSignupTime', 'leave_list', 'addTask','myTasks','notification_list', 'chatuser', 'meetings','AddNewUser','emp_list','listofproject','po_list','invoice_list','proforma_list','debitnote_list','client_list','maintask_list','department_list','services_list','currency_list','dailyblog_list'],
