        ...
        <div class="row">
          <div class="col-md-3">
               ...
               <div class="card card-primary card-outline">
                        ...
                        <div class="text-center">
                            ...
                            <?php if (!empty($emp_data)) { ?>
                                ...
                                <p class="text-muted text-center"><?= $emp_data->emp_email ?></p>

                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item">
                                        <b>Mobile No. </b> <a class="float-right"><?= $emp_data->mobile_no ?></a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Joining Date </b>
                                        <a class="float-right">
                                            <?php 
                                                echo date('d-m-Y', strtotime($emp_data->emp_joiningdate)); // formats the date as day-month-year
                                            ?>
                                        </a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Emergency No.</b> <a class="float-right"><?= $emp_data->emergency_no ?></a>
                                    </li>
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <strong><i class="fas fa-book mr-1"></i> Dept Name </strong>
                <p class="text-muted"><?= $emp_data->DepartmentName ?></p>
                <hr>
                <strong><i class="fas fa-book mr-1"></i> Programming Language</strong>

                <p class="text-muted">
                <?= $emp_data->programming_language ?>
                </p>
                <hr>
                <strong><i class="fas fa-pencil-alt mr-1"></i> Skills</strong>
                <p class="text-muted">
                  <span class="tag tag-danger"><?= $emp_data->skill_name ?></span>
                </p>
                <hr>
