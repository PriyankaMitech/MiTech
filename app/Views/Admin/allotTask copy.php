...
<!-- <script>
    // Assuming you have the employee name input field where you want to save the selected employee name
    const employeeNameInput = document.getElementById('employeeName');

    // Event delegation to handle clicks on dynamically generated dropdown items
    $(document).on('click', '.dropdown-item', function() {
        const selectedEmployeeName = $(this).text(); // Extract the employee name from the clicked item
        employeeNameInput.value = selectedEmployeeName; // Set the employee name to the input field or perform any other action you need
    });
    ...
    const employeeSelectMenu = document.getElementById('employeeSelectMenu'); // Change this to target the dropdown menu

    // Add event listener to the project select element
    $(document).ready(function() {
    // Assuming you have the employee name input field where you want to save the selected employee name
    const employeeNameInput = document.getElementById('employeeName');
    ...
    $(document).on('click', '.dropdown-item', function() {
        const selectedEmployeeName = $(this).text(); // Extract the employee name from the clicked item
        $('#employeeSelectButton').text(selectedEmployeeName); // Update the button text with the selected employee name
    });
...
<!-- // Event delegation to handle clicks on dynamically generated dropdown items
    // $(document).on('click', '.dropdown-item', function() {
    //     const selectedEmployeeName = $(this).text(); // Extract the employee name from the clicked item
    //     $(this).closest('.main-task-row').find('.employee-name').text(selectedEmployeeName); // Update the employee name in the same row
    // });
...
//     $(document).on('click', '.dropdown-item', function() {
//     const selectedEmployeeName = $(this).text(); // Extract the employee name from the clicked item
//     $('#employeeSelectButton').text(selectedEmployeeName); // Set the employee name as the button text
// });
$(document).ready(function() {
