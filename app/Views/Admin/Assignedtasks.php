                            ...
                            <tbody>
                                <?php if (!empty($assignedTasksData)) { $i = 1; ?>
                                    <?php foreach ($assignedTasksData as $task): ?>
                                        ...
                                        if ($task->start_time && $task->start_time != '0000-00-00 00:00:00') {
                                            $time_breakdown .= "<li>" . date("d M g:i a", strtotime($task->start_time));
                                        }
                                            ...
                                            <td>
                                                ...
                                                switch ($task->Developer_task_status) {
                                                    ...
                                                    case 'Bottleneck':
                                                        ...
                                                        <small class="badge badge-danger"><?= $statusLabel; ?></small>
                                                        <?php break;
                                                    case 'In Progress':
                                                        $statusLabel = 'In Progress'; ?>
                                                        <small class="badge badge-primary"><?= $statusLabel; ?></small>
                                                        <?php break;
                                                    case 'Pending':
                                                        $statusLabel = 'Pending'; ?>
                                                        <small class="badge badge-warning"><?= $statusLabel; ?></small>
                                                        <?php break;
                                                } ?>
                                            </td>
                                            <td style="width: 100%; !important"><?= $task->start_time && $task->end_time && $task->start_time != '0000-00-00 00:00:00' && $task->end_time != '0000-00-00 00:00:00' ? $time_breakdown : ''; ?></td>
                                            <td><?= $task->start_time && $task->end_time && $task->start_time != '0000-00-00 00:00:00' && $task->end_time != '0000-00-00 00:00:00' ? " (" . $hours . "h " . $minutes . "m)" : ''; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php } ?>
                            </tbody>
