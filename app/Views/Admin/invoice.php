        ...
        <tr class="row">
                ...
                <td class="col-md-6" style="padding-right: 0px !important;
                    ...
                    <table style="margin-bottom: 0px !important;">
                        <tr >
                            <td   style="padding: 5px !important"><b>Invoice No.</b>
                                <br>
                ...
                <td class="col-md-6" style="padding-right: 0px !important;
                    ...
                    <table style="margin-bottom: 0px !important;">
                        ...
                        <tr >
                            ...
                            <?php if(!empty($invoice_data)){ echo $invoice_data->vendor_code; } ?>
                            </td>
                             <td  style="padding: 5px !important" > 
                           
                            <b>Kind Attention : </b><br> <?php if(!empty($invoice_data)){ echo $invoice_data->client_name; } ?>
