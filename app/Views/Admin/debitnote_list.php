                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7 plopd">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" class="form-control" readonly name="totalamount_in_words" id="totalamount_in_words" value="<?php if(!empty($single_data)){ echo $single_data->totalamount_in_words;} ?>">  
                                                            </div>
                                                        </div>
                                                    </div>
...
$(document).ready(function() {
    $('#viewCreateDebitNoteBtn').on('click', function() {
