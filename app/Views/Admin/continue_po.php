...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="text-white">Renew PO</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active text-white">Renew PO</li>
            </ol>
        </div>
        </div>
    </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Renew PO <small></small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo base_url(); ?>set_continue_po" enctype="multipart/form" method="post" id="po_form">
                            ...
                            <div class="row card-body">
                                ...
                                <div class="col-lg-4 col-md-3 col-12 form-group">
                                    ...
                                    <input type="text" name="doc_no" class="form-control" id="doc_no" placeholder="Enter DOC NO" value="<?php if(!empty($single_data)){ echo $single_data->doc_no;} ?>(Continued)">
                                </div>
                            ...
                            <div class="card-footer text-right">
                                <button type="submit" name="submit" id="submit" class="btn btn-primary">
                                    <?php if(!empty($single_data)){ echo 'Renew'; }else{ echo 'Submit';} ?>
                                </button>
                            </div>
                        </form>
